...
export function TabletLayout({ PHONE_1, PHONE_2, EMAIL_1,  WHATSAPP }: TabletLayoutProps) {
  ...
  return (
    <div className="space-y-8">
      ...
      <section className="bg-[linear-gradient(180deg,#f3f7f5,transparent)] py-12 px-6">
        <div className="max-w-4xl mx-auto grid grid-cols-2 gap-8 items-center">
          ...
          <div>
            ...
            <div className="mt-6 flex flex-col gap-3">
              <a href={`tel:${PHONE_1}`}>
                <Button className="bg-primary hover:bg-primary/90 flex items-center gap-3 px-6 w-full justify-center">
              ...
              <button onClick={() => setCallbackOpen(true)}>
                <Button variant="outline" className="px-6 w-full justify-center bg-transparent">
      ...
      <section className="px-6 py-8">
        <div className="max-w-5xl mx-auto grid grid-cols-2 gap-8">
          <div>
            <h2 className="text-2xl font-bold mb-4">{isEn ? "Why Solar?" : "सोलर क्यों?"}</h2>
          ...
          <div>
            <h2 className="text-2xl font-bold mb-4">{isEn ? "How It Works" : "प्रक्रिया"}</h2>
      ...
      {/* Before/After Chart */}
      <section className="px-6 py-8">
        <div className="max-w-2xl mx-auto bg-white border border-border rounded-md p-4">
          <div className="font-semibold text-lg mb-4 text-center">{isEn ? "Before / After" : "पहले / बाद"}</div>
          <Image
      ...
      <section className="py-10 px-6 bg-gray-50">
        <h3 className="text-xl font-bold mb-6 text-center">{isEn ? "Our Solar Range" : "हमारे सोलर ब्रैंड"}</h3>

        <div className="max-w-4xl mx-auto grid grid-cols-3 gap-6 items-center justify-items-center mb-8">
          <Image
            src="/waaree-logo.png"
            alt="Waaree"
            width={160}
      ...
      <section className="bg-primary text-primary-foreground py-10 px-6">
        <div className="max-w-5xl mx-auto grid grid-cols-3 gap-6 items-start">
          <div className="col-span-2">
            <h3 className="text-2xl font-bold">{isEn ? "Free Site Visit" : "नि:शुल्क साइट विज़िट"}</h3>
            ...
            <div className="mt-5 flex gap-3">
              <a href={`tel:${PHONE_1}`} className="flex-1">
                <Button className="bg-white text-primary font-semibold flex items-center gap-2 justify-center w-full shadow-sm hover:bg-white/90 transition">
                  <Phone className="w-4 h-4" /> {isEn ? "Call Now" : "अभी कॉल करें"}
                </Button>
              </a>

              <a href={WHATSAPP} target="_blank" rel="noreferrer" className="flex-1">
                <Button
                  variant="outline"
          ...
          <div className="bg-white rounded-md p-4 border border-border text-foreground space-y-3">
